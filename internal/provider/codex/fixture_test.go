...
func TestSanitizedRealUsageFixtures(t *testing.T) {
	...
	for _, path := range paths {
		...
		if fixture.Provider != "codex" || fixture.Kind != "usage" {
			continue
		}
	...
	if count == 0 {
		requireUnavailableFixtureStatus(t, "codex")
		t.Skip("approved sanitized-real Codex usage fixture is unavailable; provider compatibility remains a human release proof")
	}
}
